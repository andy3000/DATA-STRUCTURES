 ...
 * @brief This program creates a graph and evaluates it.
...
void WeightedGraph::insertEdge( const string& v1, const string& v2, int wt ) throw ( logic_error )
{
	...
	if( v1 != v2 )
	{
		...
		cout << "Size = " << size << ", idx_v1 = " << v1Location << ", idx_v2 = " << v2Location << endl;
	}		
}
 ...
 * hasProperColoring
 * 
 * This function will loop over the vertexList and check to see if
 * any of the vertexes in the list have the same color. If any have the
 * same color, then this function will return true.
 *
 * @return This has an bool return.
 * 
 * @pre It won't be known if there is proper coloring.
 * @post It will be known if there is proper coloring.
 * 
*/
 ...
 * areAllEven.
 * 
 * This function will loop over the adjMatrix and check to see if each
 * vertex in the graph has even degrees. If any of the vertexes don't have
 * even degrees, then this function will return false. 
 * 
 * @pre It won't be known if there is even degrees.
 * @post It will be known if there is even degrees.
 * 
*/
